pipeline {
    ...
    environment {
        ...
        ARTIFACTORY_USERNAME = "soundboylesh77@gmail.com"  // JFrog username
        ARTIFACTORY_PASSWORD = "cmVmdGtuOjAxOjE3NzM5MjAxMTI6QjhielhUelW13emFkQk1uMmFSU1U4MUpnTjR0" // JFrog API Token
    }
        ...
        stage('Docker Build and Publish') {
            steps {
                script {
                    ...
                    docker.withRegistry("https://${ARTIFACTORY_URL}", 'b3568e44-b80f-4700-8194-fd0547ee6230') {
